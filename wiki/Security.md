...
✅ All storage is browser-based (IndexedDB)  
...
⚠️ **Important**: Ensure your organization's policies allow:
...
- 🔒 Check repository [SECURITY.md](https://github.com/chovancova/conversation-agent-t/blob/main/SECURITY.md)
- 🐛 [Report security issues](https://github.com/chovancova/conversation-agent-t/security) privately
